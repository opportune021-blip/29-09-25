...
<div className="bg-white dark:bg-slate-800 rounded-xl p-6 border border-slate-300 dark:border-slate-700 shadow-md flex flex-col">
  ...
  <p className="mb-4">
    While 'y' is correct, function notation <InlineMath>{'f(x)'}</InlineMath> is a more powerful and descriptive way to write our rules.
  </p>

  <div className="space-y-3">
    <p>
      The notation <InlineMath>{'f(x) = 2x + 1'}</InlineMath> is read as "<strong>f of x</strong> equals 2x plus 1."
    </p>

    <div className="p-3 bg-slate-50 dark:bg-slate-900/30 rounded-lg border border-slate-200 dark:border-slate-600">
      <ul className="list-disc pl-5 space-y-2">
        <li>
          The <InlineMath>{'f'}</InlineMath> is the <strong>name</strong> of the function.
        </li>
        <li>
          The <InlineMath>{'(x)'}</InlineMath> tells us the <strong>input</strong> variable.
        </li>
        <li>
          The whole expression <InlineMath>{'f(x)'}</InlineMath> represents the <strong>output</strong> (it's the new 'y'!).
        </li>
      </ul>
    </div>
    ...
    <div>
      ...
      <p>
        It gives clear instructions. "Find <InlineMath>{'f(2)'}</InlineMath>" is a complete command: "Use function 'f' and plug in an input of 2."
      </p>
    </div>
  </div>
</div>
