       ...
       {/*  <h2 className="text-3xl font-bold text-center mb-6">Understanding the y-intercept (b)</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 flex-grow">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 border border-slate-300 dark:border-slate-700 shadow-md flex flex-col">
            ...
            <p>If the slope (<InlineMath>{'m'}</InlineMath>) is the line's engine, the y-intercept (<InlineMath>{'b'}</InlineMath>) is its **"launching pad"**.</p>
            <div className="my-4 p-4 bg-blue-50 dark:bg-blue-900/30 border-l-4 border-blue-400 rounded-r-lg">
                ...
                <p className="text-sm">The x-coordinate of the y-intercept is **always 0**. The point is always written as <InlineMath>{'(0, b)'}</InlineMath>.</p>
            </div>

            <h4 className="font-bold mt-4">How 'b' Affects the Graph</h4>
            <p className="text-sm mt-2">Changing <InlineMath>{'b'}</InlineMath> just **shifts the line up or down**. Lines with the same slope are parallel.</p>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 border border-slate-300 dark:border-slate-700 shadow-md flex flex-col">
            ...
            <p className="text-sm">In real-world problems, <InlineMath>{'b'}</InlineMath> is your **starting value** before any change happens.</p>
            <div className="mt-4 space-y-3">
                <div className="p-3 bg-slate-50 dark:bg-slate-700/50 rounded-md">
                    ...
                    <p className="text-sm"><InlineMath>{'b = 23'}</InlineMath> is the starting fare you pay at **0 kilometers**.</p>
                </div>
                <div className="p-3 bg-slate-50 dark:bg-slate-700/50 rounded-md">
                    <p className="font-semibold">Savings Account: <InlineMath>{'y = 100x + 500'}</InlineMath></p>
                    <p className="text-sm"><InlineMath>{'b = 500'}</InlineMath> is the initial ₹500 you had **before** you started saving ₹100 weekly.</p>
                </div>
            </div>
