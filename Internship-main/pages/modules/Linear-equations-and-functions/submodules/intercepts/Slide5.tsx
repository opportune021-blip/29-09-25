...
export default function InterceptsAssessment({ questions }: Props) {
    const [localInteractions, setLocalInteractions] = useState<Record<string, InteractionResponse>>({});
    const slideInteractions: Interaction[] = questions ? questions.map((q: Question) => ({...q, conceptId: 'intercepts-assessment', conceptName: 'Intercepts Assessment', type: q.inputType})) : [];
