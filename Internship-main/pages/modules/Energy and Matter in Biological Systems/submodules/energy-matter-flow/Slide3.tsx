      ...
      <div className="max-w-4xl mx-auto p-8 space-y-8">
        ...
        >
          <h1 className="text-4xl font-bold text-blue-600 dark:text-blue-400 mb-4">
            Video: Impact of Changes to Trophic Pyramids
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-2 text-center">
              Video: Exploring trophic levels and the cascading effects of population changes.
            </p>
          </motion.div>
          ...
          >
            ...
            <ul className="space-y-3 text-lg">
              <li className="flex items-start">
                ...
                <span>**Trophic Levels:** The position an organism occupies in a food chain (e.g., producer, primary consumer, etc.).</span>
              </li>
              <li className="flex items-start">
                <span className="font-bold text-emerald-500 mr-2">✓</span>
                <span>**Energy Pyramids:** Why energy, biomass, and population numbers decrease as you move up the pyramid.</span>
              </li>
              <li className="flex items-start">
                <span className="font-bold text-emerald-500 mr-2">✓</span>
                <span>**Trophic Cascade:** How changes at a top trophic level (like removing a predator) can drastically affect the levels below.</span>
              </li>
            </ul>
          </motion.div>
        </div>
