...
export default function WordProblemCompSlide() {
  ...
  // Config
  const GRID = 1; // Custom scaling for the scene
  ...
  const slideContent = (
    <div className="w-full h-full p-4 sm:p-6 flex flex-col lg:flex-row gap-6 items-stretch">
      ...
      <div className="lg:w-1/2 flex flex-col h-full gap-6">
        ...
        <div className="bg-gradient-to-b from-sky-100 to-blue-50 dark:from-slate-800 dark:to-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 relative flex-grow overflow-hidden select-none shadow-inner flex items-center justify-center min-h-[400px]">
            
            {/* Dynamic Effect Meters */}
            ...
            {/* Ground */}
            <div className="absolute bottom-0 w-full h-24 bg-white/50 dark:bg-slate-800/50 border-t border-slate-300 dark:border-slate-600 backdrop-blur-sm">
      ...
      <div className="lg:w-1/2 flex flex-col h-full bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden">
        ...
        <div className="p-6 border-b border-slate-100 dark:border-slate-700">
            <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100">Real-World Application</h2>
            <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">
                Resolving force into Motion (Horizontal) and Lift (Vertical).
            </p>
        </div>
        ...
        <div className="p-6 space-y-6 overflow-y-auto custom-scrollbar flex-grow">
            ...
            <div className="bg-slate-50 dark:bg-slate-900 p-4 rounded-lg border border-slate-200 dark:border-slate-700">
                <h3 className="font-bold text-slate-800 dark:text-slate-100 mb-4 text-sm uppercase tracking-wide">Problem Parameters</h3>
                
                {/* Force Slider */}
                <div className="mb-4">
                    <div className="flex justify-between items-center mb-2">
                        <span className="font-bold text-red-600 text-sm">Total Force (<InlineMath>F</InlineMath>)</span>
                        <span className="font-mono bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300 px-2 rounded text-xs">{force} N</span>
                    </div>
                    <input 
                ...
                <div>
                    <div className="flex justify-between items-center mb-2">
                        <span className="font-bold text-slate-600 dark:text-slate-300 text-sm">Angle (<InlineMath>\theta</InlineMath>)</span>
                        <span className="font-mono bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300 px-2 rounded text-xs">{angle}°</span>
                    </div>
                    <input 
            ...
            <div className="space-y-4">
                ...
                <div className="bg-blue-50 dark:bg-blue-900/10 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
                    <h4 className="font-bold text-blue-800 dark:text-blue-200 mb-2 text-xs uppercase tracking-wide">1. Horizontal Component (Motion)</h4>
                    <p className="text-xs text-slate-600 dark:text-slate-400 mb-2">
                        The adjacent side uses <strong>Cosine</strong>.
                    </p>
                    <div className="font-mono bg-white dark:bg-slate-800 p-3 rounded text-xs text-slate-700 dark:text-slate-300 border border-blue-100 dark:border-blue-900 overflow-x-auto">
                ...
                <div className="bg-emerald-50 dark:bg-emerald-900/10 p-4 rounded-lg border border-emerald-200 dark:border-emerald-800">
                    <h4 className="font-bold text-emerald-800 dark:text-emerald-200 mb-2 text-xs uppercase tracking-wide">2. Vertical Component (Lift)</h4>
                    <p className="text-xs text-slate-600 dark:text-slate-400 mb-2">
                        The opposite side uses <strong>Sine</strong>.
                    </p>
                    <div className="font-mono bg-white dark:bg-slate-800 p-3 rounded text-xs text-slate-700 dark:text-slate-300 border border-emerald-100 dark:border-emerald-900 overflow-x-auto">
